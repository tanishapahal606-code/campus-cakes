  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <motion.div
        ...
        className="relative bg-white w-full max-w-lg md:max-w-2xl rounded-3xl overflow-hidden shadow-2xl border border-gray-100 max-h-[92vh] flex flex-col z-50"
      >
        ...
        <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-5 md:p-6 space-y-6">
          ...
          {cake.category === 'Photo Cakes' && (
            <div className="p-4 bg-gray-50 rounded-3xl border border-gray-200/50">
              <div className="flex justify-between items-start mb-2">
                <div>
                  <label className="block text-xs font-black text-gray-800 uppercase tracking-widest">
                    📸 Edible Photo Grid Upload
                  </label>
                  <p className="text-[10px] text-gray-500">Add an Instax snapshot memory directly printed on sugar shell.</p>
                </div>
                {photoUrl && (
              ...
              <div className="flex items-center gap-4 mt-1">
                {photoUrl ? (
                  ...
                  <button
                    ...
                    className="flex-shrink-0 w-14 h-14 rounded-xl border-2 border-dashed border-pink-300 hover:border-pink-500 bg-pink-50/30 flex flex-col items-center justify-center p-1 text-pink-600 hover:bg-pink-50 transition-colors"
                  >
                ...
                <div className="flex-1">
                  <input
                    ...
                    className="w-full px-3 py-2 bg-white border border-gray-200 rounded-xl text-[11px] focus:outline-none focus:ring-1 focus:ring-pink-500"
                  />
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                ...
                className={`p-3 rounded-2xl border flex items-center gap-3 transition-all ${
                  addCandles
                    ? 'bg-pink-50/60 border-pink-400 text-pink-800'
                    : 'bg-gray-50/50 border-gray-100 text-gray-700 hover:bg-gray-50'
                }`}
              >
                <div className={`w-4 h-4 rounded-md border flex items-center justify-center ${addCandles ? 'bg-pink-600 border-pink-600 text-white' : 'bg-white border-gray-300'}`}>
                  {addCandles && <Check className="w-3 h-3 stroke-[3]" />}
                </div>
                <div className="text-left">
                  <p className="font-bold text-xs">Aromatherapy Candles</p>
                  <p className="text-[9px] text-pink-600">Free set of 5</p>
                </div>
              </button>
              ...
              >
                <div className={`w-4 h-4 rounded-md border flex items-center justify-center ${addKnife ? 'bg-pink-600 border-pink-600 text-white' : 'bg-white border-gray-300'}`}>
                  {addKnife && <Check className="w-3 h-3 stroke-[3]" />}
                </div>
                <div className="text-left">
                  <p className="font-bold text-xs">Recyclable Cake Knife</p>
                  <p className="text-[9px] text-pink-600">Free wooden knife</p>
                </div>
              </button>
            </div>
          </div>
          ...
          <div className="border-t border-dashed border-gray-200 pt-5 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-1">
                ...
                <input
                  ...
                  className="w-full px-3 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-xs font-bold focus:outline-none focus:ring-1 focus:ring-pink-500"
                />
              </div>
              <div className="space-y-1">
            ...
            {timeWarning ? (
              <div className="p-4 bg-red-50 rounded-2xl border border-red-200 flex items-start gap-2.5 text-red-800">
              ...
              <div className="p-3 bg-green-50 rounded-2xl border border-green-100 flex items-start gap-2.5 text-green-800">
                ...
                <div className="text-[10px] leading-relaxed">
                  ...
                  <p className="text-gray-500 font-medium">Your scheduled checkout is more than 24 hours out. Fresh, on-time baking is fully guaranteed.</p>
                </div>
              </div>
            )}
          </div>
        ...
        <div className="bg-gray-50 border-t border-gray-100 p-4 md:p-5 flex items-center justify-between flex-shrink-0">
          <div>
            <p className="text-[10px] font-bold text-gray-400 uppercase leading-none">Net Total Value</p>
            <p className="text-xl font-black text-gray-900 mt-0.5">₹{Math.round(calculatedPrice)}</p>
          </div>
          ...
          <div className="flex gap-2">
            <button
              type="button"
              onClick={onClose}
              className="px-4 py-2.5 bg-white border border-gray-200 hover:bg-gray-50 text-gray-700 font-extrabold rounded-xl text-xs transition-colors"
            >
              Cancel
            </button>
            <button
